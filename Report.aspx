<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Insurance_management_System.Report" %>
                ...
                <div class="profile-info col-md-9">
                    ...
                    <div class="panel">
                        <div class="bio-graph-heading" style="font-size: 30px;">
                            See Your Purchased  Policy .
                        </div>
                        <hr  class="new5">
                        <div class="panel-body bio-graph-info" style="margin-top: 50px;">
                           <strong> <b><h1>Details About Your's  Policy</h1></b></strong>
                            <asp:Repeater ID="rep1" runat="server">
                                <ItemTemplate>
                                    ...
                                    <div class="row" style="margin-top: 40px;">
                                        ...
                                        <div class="bio-row">
                                            <p><span><b>Purchase Id </b></span>: <%# Eval("Purchase_id") %></p>
                                        </div>
                                        <div class="bio-row">
                                            <p><span><b>Customer Id</b></span>: <%# Eval("Customer_id") %></p>
                                        </div>
                                        <div class="bio-row">
                                            <p><span><b>Policy Id </b></span>: <%# Eval("Policy_id") %></p>
                                        </div>
                                        <div class="bio-row">
                                            <p><span><b>Order ID </b></span>: <%# Eval("Order_id") %></p>
                                        </div>
                                        <div class="bio-row">
                                            <p><span><b>Purchase  Date </b></span>: <%# Eval("Purchase_date") %></p>
                                        </div>
                                        <div class="bio-row">
                                            <p><span><b>Purchase  Time</b></span>: <%# Eval("Purchase_Time") %></p>
                                        </div>
                                        <hr  class="new5">
                                        </div>
                                </ItemTemplate>
                ...
                <div class="container">
                   <%-- <div class="row">
                        <div>
                            ...
                            <a href="demoreg.aspx" class="btn btn-danger" style="width: 300px; margin-left: 580px; margin-top: 50px;">Show your Report</a>
                        </div>
                    </div>--%>
                </div>
            </div>
