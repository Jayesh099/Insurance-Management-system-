<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addagent.aspx.cs" Inherits="Insurance_management_System.Admin.addagent" %>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Add Agent</a></li>
             ...
             <!-- ============================================================== -->
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:80px;">
                            <div class="card">
                                <h5 class="card-header"><i>Add Agent Details</i></h5>
                                <asp:Label ID="lblMessage" runat="server"></asp:Label>
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="" runat="server">
                                        <div class="form-group">
                                            <!--<label for="inputUserName">User Name</label>-->
                                            <asp:TextBox ID="TextBox1" runat="server"  data-parsley-trigger="change" required="" placeholder="Enter user name" autocomplete="off" class="form-control"></asp:TextBox>
         ...
         <!--image ksa add kraga -->                     <asp:Label ID="imageupload" runat="server" required=""></asp:Label>
