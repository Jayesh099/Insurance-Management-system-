<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="policy.aspx.cs" Inherits="Insurance_management_System.Admin.addsubcategory" %>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add  Policy </h2>
                                       ...
                                       -->  </div>
                                        <div class="form-group">
                                            ...
                                            <!--Image code --->
                                                     ...
                                                     <div class="form-group">
                                                          <asp:TextBox ID="TextBox6"   runat="server"  required="" placeholder="Premium  Per year.........." autocomplete="off" class="form-control"></asp:TextBox>
                                                     </div>
                                                        <div class="row">
