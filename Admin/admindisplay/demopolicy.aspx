<%@ Page Language="C#" AutoEventWireup="true" CodeFile="demopolicy.aspx.cs" Inherits="Insurance_management_System.Admin.admindisplay.demopolicy" %>
                                ...
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="" runat="server">
                                        <div class="form-group">
                                            ...
                                            <select  class="" name="catid" Id="select ">
                                            <%=get_brand_name() %>
                                            </select>
                                       ...
                                       -->  </div>
                                        <div class="form-group">
                                            ...
                                            <div  class="form-group">
                                               ...
                                               <b><asp:Label ID="imageupload" runat="server" Text="Upload Policy  Image"></asp:Label></b>
                                            ...
                                            <!--Image code --->
                                                     ...
                                                     <div class="form-group">
                                                          <asp:TextBox ID="TextBox6"   runat="server"  required="" placeholder="Policy premium amount  .........." autocomplete="off" class="form-control"></asp:TextBox>
                                                     </div>
                                             <!--  pdf  upload -->
                                            <div  class="form-group">
                                                <asp:Label ID="label" runat="server" Text="Pdf  Upload"  ></asp:Label>
                                            ...
                                            <!--  pdf  upload -->
                                                    <div class="form-group">
                                                          <asp:TextBox ID="dicount"   runat="server"  required="" placeholder=" Discount.........." autocomplete="off" class="form-control"></asp:TextBox>
                                                     </div>
