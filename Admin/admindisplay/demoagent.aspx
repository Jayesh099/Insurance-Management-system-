<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demoagent.aspx.cs" Inherits="Insurance_management_System.Admin.admindisplay.democustomerview" %>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex px-2 py-1">
                                                                            <div class="d-flex flex-column justify-content-center">
                                                                                <a onclick="return confirm('Are you sure to delete the record ?')" href="demoagent.aspx?delid=<%#Eval("Agent_id") %>" style="margin-left: 20px;">Delete</a>
                                                                                <a onclick="return confirm('Are you sure to Update the record ?')" href="updateform.aspx?upid=<%#Eval("Agent_id") %>" style="margin-left: 20px;">update</a>
