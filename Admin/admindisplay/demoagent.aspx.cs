...
{
    public partial class democustomerview : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlDataAdapter adp = new SqlDataAdapter("select * from agent order by Agent_id desc", con);
        ...
        private void delete_member()
        {
            ...
            {
                int Aid;
                Aid = Convert.ToInt32(Request.QueryString["delid"]);
                String delete = "delete from agent where Agent_id='" + Aid + "'";
                Response.Write(delete);
                SqlCommand cmd = new SqlCommand(delete, con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Redirect("democustomerview.aspx");
            }
